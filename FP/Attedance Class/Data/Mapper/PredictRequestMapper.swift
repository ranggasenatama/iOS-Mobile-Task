...
public class PredictRequestMapper: MapperBase<PredictRequestEntity, PredictRequestData> {
    ...
    public override func mapToEntity(model: PredictRequestData) -> PredictRequestEntity {
        ...
        return PredictRequestEntity(_user: UserEntity(_nrp: model.nrp, _password: model.password), _image: ImageEntity(_image: imageData), _agenda: AgendaEntity(_lat: model.Lat, _lon: model.Lon, _idAgenda: model.idAgenda))
    }
    ...
    public override func mapToModel(entity: PredictRequestEntity) -> PredictRequestData {
        ...
        return PredictRequestData(_nrp: entity.user.nrp, _password: entity.user.password, _image: imageBase64, _lat: entity.agenda.Lat, _lon: entity.agenda.Lon, _idAgenda: entity.agenda.idAgenda)
    }
}
